...
function rplg_serialize_connections() {
    ...
    var options = document.querySelector('.rplg-connect-options').querySelectorAll('input,select,textarea');
    if (options.length > 0) {
        connections.options = {};
    }
    for (var o in options) {
        if (Object.prototype.hasOwnProperty.call(options, o)) {
            ...
            if (input.type == 'checkbox') {
                ...
                connections.options[name] = (input.type == 'textarea' ? escape(input.value) : input.value);
            }
        }
    }
                    ...
                    if (Object.prototype.hasOwnProperty.call(connections.options, opt)) {
                        ...
                        if (control) {
                            if (typeof(connections.options[opt]) === 'boolean') {
                                ...
                                control.value = (control.type == 'textarea' ? unescape(connections.options[opt]) : connections.options[opt]);
