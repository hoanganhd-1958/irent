                            ...
                            echo '<div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 display-table">';
                                echo '<div class="display-table-cell vertical-align-middle text-left sm-text-center">';
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="alt-font text-extra-dark-gray font-weight-600 no-margin-bottom pofo-archive-title '.esc_attr( $pofo_archive_title_text_transform ).'">'.esc_attr( $pofo_archive_title ).'</h1>';
                                    }
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="display-block margin-5px-top alt-font pofo-archive-subtitle">'.$pofo_archive_title_subtitle.'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
                        ...
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 display-table sm-margin-15px-top page-title-small pull-right">';
                                echo '<div class="display-table-cell vertical-align-middle text-right sm-text-center">';
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="alt-font text-extra-dark-gray font-weight-600 no-margin-bottom pofo-archive-title '.esc_attr( $pofo_archive_title_text_transform ).'">'.$pofo_archive_title.'</h1>';
                                    }
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="display-block margin-5px-top alt-font pofo-archive-subtitle">'.$pofo_archive_title_subtitle.'</span>';
                                    }
                        ...
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table page-title-medium">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="alt-font text-extra-dark-gray font-weight-600 no-margin pofo-archive-title '.esc_attr( $pofo_archive_title_text_transform ).'">'.$pofo_archive_title.'</h1>';
                                    }
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="display-block center-col margin-10px-top alt-font pofo-archive-subtitle">'.$pofo_archive_title_subtitle.'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
                    ...
                    echo '<div class="row">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table extra-small-screen page-title-medium center-col page-title-content-wrap">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="alt-font text-white font-weight-600 no-margin letter-spacing-1 pofo-archive-title '.esc_attr( $pofo_archive_title_text_transform ).'">'.$pofo_archive_title.'</h1>';
                                    }
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="display-block margin-10px-top text-extra-small alt-font pofo-archive-subtitle">'.$pofo_archive_title_subtitle.'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
                    ...
                    echo '<div class="row">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 extra-small-screen display-table page-title-extra-small page-title-content-wrap">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="alt-font text-white opacity7 margin-10px-bottom pofo-archive-title '.esc_attr( $pofo_archive_title_text_transform ).'">'.$pofo_archive_title.'</h1>';
                                    }
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<h2 class="text-white alt-font font-weight-500 width-55 sm-width-65 center-col xs-width-100 letter-spacing-minus-1 line-height-50 sm-line-height-45 xs-line-height-30 pofo-archive-subtitle">'.$pofo_archive_title_subtitle.'</h2>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
                    ...
                    if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                        echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table page-title-large page-title-content-wrap">';
                            echo '<div class="display-table-cell vertical-align-middle text-center padding-30px-tb">';
                                if( $pofo_archive_title_subtitle ){
                                    echo '<span class="display-block text-white opacity6 alt-font margin-5px-bottom pofo-archive-subtitle">'.$pofo_archive_title_subtitle.'</span>';
                                }
                                if( $pofo_archive_title ){
                                    echo '<h1 class="alt-font text-white font-weight-600 no-margin-bottom pofo-archive-title '.esc_attr( $pofo_archive_title_text_transform ).'">'.$pofo_archive_title.'</h1>';
                                }
                            echo '</div>';
                        echo '</div>';
                    }
                    ...
                    echo '<div class="row">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table one-third-screen z-index-2 page-title-large page-title-content-wrap">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="display-block text-white opacity6 margin-10px-bottom alt-font pofo-archive-subtitle">'.$pofo_archive_title_subtitle.'</span>';
                                    }
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="alt-font text-white font-weight-600 width-55 sm-width-80 xs-width-100 center-col no-margin-bottom pofo-archive-title '.esc_attr( $pofo_archive_title_text_transform ).'">'.$pofo_archive_title.'</h1>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
                    ...
                    echo '<div class="row">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != ''){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 z-index-3 display-table one-third-screen page-title-medium page-title-content-wrap">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="margin-5px-bottom display-block alt-font text-medium-gray pofo-archive-subtitle">'.$pofo_archive_title_subtitle.'</span>';
                                    }
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="text-white alt-font font-weight-600 letter-spacing-minus-1 pofo-archive-title '.esc_attr( $pofo_archive_title_text_transform ).'">'.$pofo_archive_title.'</h1>';
                                    }
                                    if( $pofo_disable_breadcrumb == 1 ){
                    ...
                    echo '<div class="row">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 extra-small-screen display-table page-title-large page-title-content-wrap">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="text-white alt-font font-weight-600 letter-spacing-minus-1 margin-10px-bottom pofo-archive-title '.esc_attr( $pofo_archive_title_text_transform ).'">'.$pofo_archive_title.'</h1>';
                                    }
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="text-white alt-font margin-15px-bottom pofo-archive-subtitle display-block opacity6">'.$pofo_archive_title_subtitle.'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
