                    ...
                    if( $pofo_page_title != '' || $pofo_page_title_subtitle != '' ){
                        echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table page-title-large page-title-content-wrap">';
                            echo '<div class="display-table-cell vertical-align-middle text-center padding-30px-tb">';
                                if( $pofo_page_title_subtitle && ( $pofo_disable_page_subtitle == 1 || $pofo_disable_page_subtitle == '' ) ){
                                    echo '<span class="display-block text-white opacity6 alt-font margin-5px-bottom pofo-page-subtitle">'.$pofo_page_title_subtitle.'</span>';
                                }
                                if( $pofo_page_title ){
                                    echo '<h1 class="alt-font text-white font-weight-600 no-margin-bottom pofo-page-title '.$pofo_page_title_text_transform.'">'.$pofo_page_title.'</h1>';
                                }
                            echo '</div>';
                        echo '</div>';
                    }
