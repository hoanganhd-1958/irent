<?php
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pofo_portfolio_archive_title_opacity_color', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pofo_portfolio_archive_title_bg_color', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pofo_portfolio_archive_title_color', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pofo_portfolio_archive_subtitle_color', array(
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pofo_portfolio_archive_title_breadcrumb_bg_color', array(
        'label'             => esc_attr__( 'Breadcrumb Background', 'pofo' ),
        'section'           => 'pofo_add_portfolio_archive_title_section',
        'settings'          => 'pofo_portfolio_archive_title_breadcrumb_bg_color',
        'active_callback'   => 'pofo_portfolio_archive_title_breadcrumb_bg_callback',
    ) ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pofo_portfolio_archive_title_breadcrumb_border_color', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pofo_portfolio_archive_title_breadcrumb_color', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pofo_portfolio_archive_title_breadcrumb_text_hover_color', array(
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pofo_portfolio_archive_title_icon_bg_color', array(
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pofo_portfolio_archive_title_icon_color', array(
	...
	if ( ! function_exists( 'pofo_portfolio_archive_title_breadcrumb_bg_callback' ) ) :
        function pofo_portfolio_archive_title_breadcrumb_bg_callback( $control ){
            if ( $control->manager->get_setting( 'pofo_portfolio_archive_disable_breadcrumb' )->value() == '1' && ( $control->manager->get_setting( 'pofo_portfolio_archive_title_style' )->value() == 'page-title-style-3' || $control->manager->get_setting( 'pofo_portfolio_archive_title_style' )->value() == 'page-title-style-4' || $control->manager->get_setting( 'pofo_portfolio_archive_title_style' )->value() == 'page-title-style-5' || $control->manager->get_setting( 'pofo_portfolio_archive_title_style' )->value() == 'page-title-style-6' || $control->manager->get_setting( 'pofo_portfolio_archive_title_style' )->value() == 'page-title-style-7' || $control->manager->get_setting( 'pofo_portfolio_archive_title_style' )->value() == 'page-title-style-10' ) ) {
                return true;
            } else {
                return false;
            }
